<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $lang['setting_general_lanaguage_title'] = "Language";
    $lang['setting_general_lanaguage_desc'] = "What lanaguge do you want to use?";
	...
	$lang['setting_support_support_users_canopen_title'] = "Can users open?";
	$lang['setting_support_support_users_canopen_desc'] = "Are users allowed to open their own support tickets?";
